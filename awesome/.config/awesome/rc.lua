...
run_once({ "urxvtd", "lxsession", "unclutter -root" }) -- entries must be separated by commas
...
globalkeys = my_table.join(
	...
	awful.key({ "Shift"           }, "Alt_L", function () mykeyboardlayout:next_layout() end,
	          {description = "Switch layout", group = "awesome"}),
...
client.connect_signal("request::display", function(notification) notification.timeout = 0 end)
